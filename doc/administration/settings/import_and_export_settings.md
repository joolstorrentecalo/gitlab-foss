...
## Allow contribution mapping to admins

> - Introduced in GitLab 17.5 [with flag](../../administration/feature_flags.md) named `importer_user_mapping`. Disabled by default.

Allow mapping of imported user contributions to instance admins.

To allow mapping of imported user contributions to instance admins:

1. On the left sidebar, at the bottom, select **Admin**.
1. Select **Settings > General**, then expand **Import and export settings**.
1. Scroll to **Allow contribution mapping to admins**.
1. Select the **Enabled** checkbox.
