...
Reassigning contributions to users with admin privileges is disabled by default, but can be
[enabled](../../../administration/settings/import_and_export_settings.md#allow-contribution-mapping-to-admins).
