...
| [`allowed_email_domain_added`](https://gitlab.com/gitlab-org/gitlab/-/issues/386080) | Triggered when group setting allowed email domain entry is added | **{check-circle}** Yes | **{check-circle}** Yes | GitLab [17.4](https://gitlab.com/gitlab-org/gitlab/-/issues/486532) | Group |
| [`allowed_email_domain_deleted`](https://gitlab.com/gitlab-org/gitlab/-/issues/386080) | Triggered when group setting allowed email domain entry is deleted | **{check-circle}** Yes | **{check-circle}** Yes | GitLab [17.4](https://gitlab.com/gitlab-org/gitlab/-/issues/486532) | Group |
