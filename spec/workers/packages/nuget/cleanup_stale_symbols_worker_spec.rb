...
RSpec.describe Packages::Nuget::CleanupStaleSymbolsWorker, type: :worker, feature_category: :package_registry do
  ...
  describe '#perform_work' do
    ...
    context 'with work to do' do
      ...
      let_it_be(:symbol_2) { create(:nuget_symbol, :pending_destruction) }

      it 'deletes the pending destruction symbol', :aggregate_failures do
    ...
    context 'with a pending destruction symbol' do
      let_it_be(:symbol) { create(:nuget_symbol, :pending_destruction) }
