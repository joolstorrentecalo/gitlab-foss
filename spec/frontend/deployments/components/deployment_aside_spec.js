  ...
  describe('toggle button', () => {
    ...
    describe('when the sidebar is collapsed', () => {
      ...
      it('expands the sidebar on click', async () => {
        ...
        createComponent({ data: { isExpanded: false } });
    ...
    describe('when the sidebar is expanded', () => {
      it('has correct attributes', () => {
        createComponent({ data: { isExpanded: true } });
  ...
  describe('sidebar items', () => {
    ...
    describe('on mobile', () => {
      ...
      it('has correct CSS classes', () => {
        ...
        expect(sidebarItems.classes()).toContain('gl-border-t-1');
        expect(sidebarItems.classes()).toContain('gl-mt-5');
        expect(sidebarItems.classes()).toContain('gl-border-gray-100');
        expect(sidebarItems.classes()).toContain('gl-border-t-solid');
      });
    });
  });
  ...
  describe('url button wrapper', () => {
    ...
    describe('on mobile', () => {
      it('has correct CSS classes', () => {
        ...
        expect(urlButtonWrapper.classes()).toContain('gl-border-b-1');
        expect(urlButtonWrapper.classes()).toContain('gl-border-gray-100');
        expect(urlButtonWrapper.classes()).toContain('gl-pb-5');
        expect(urlButtonWrapper.classes()).toContain('gl-border-b-solid');
      });
    });
  });
  ...
  describe('triggerer item', () => {
    describe('on desktop', () => {
      it('has correct CSS classes', () => {
        ...
        expect(triggererItem.classes()).toContain('gl-border-gray-50');
        expect(triggererItem.classes()).not.toContain('gl-mt-5');
        expect(triggererItem.classes()).not.toContain('gl-border-gray-100');
      });
    });
    ...
    describe('on mobile', () => {
      it('has correct CSS classes', () => {
        ...
        expect(triggererItem.classes()).toContain('gl-border-gray-100');
        expect(triggererItem.classes()).not.toContain('gl-mt-8');
        expect(triggererItem.classes()).not.toContain('gl-border-gray-50');
      });
    });
  });
});
