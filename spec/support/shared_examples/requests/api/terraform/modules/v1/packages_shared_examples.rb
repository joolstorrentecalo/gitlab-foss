...
RSpec.shared_examples 'allowing anyone to pull public terraform modules' do |success_shared_example, status = :success|
  let(:headers) { {} }
  ...
  it_behaves_like success_shared_example, :anonymous, status, false
