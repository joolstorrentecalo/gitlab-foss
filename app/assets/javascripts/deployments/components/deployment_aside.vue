...
export default {
  ...
  computed: {
    ...
    triggererClasses() {
      return this.isDesktop ? 'gl-mt-8 gl-border-gray-50' : 'gl-mt-5 gl-border-gray-100';
    },
    toggleCategory() {
...
<template>
  ...
  >
    ...
    <div
      ...
      :class="{ 'gl-mt-5 gl-border-t-1 gl-border-gray-100 gl-border-t-solid': isMobile }"
    >
      <div
        v-if="hasUrl"
        data-testid="deployment-url-button-wrapper"
        :class="{
          'gl-mt-5 gl-border-b-1 gl-border-gray-100 gl-pb-5 gl-border-b-solid': isMobile,
        }"
      >
        <gl-button
          category="secondary"
      ...
      <aside-item
        ...
        class="gl-border-b-1 gl-pb-5 gl-border-b-solid"
      >
        <template #header>
