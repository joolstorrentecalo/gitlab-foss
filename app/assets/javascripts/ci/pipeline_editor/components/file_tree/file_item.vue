...
<template>
  <gl-link
    ...
    :title="fileName"
    target="_blank"
    class="another-class file-tree-includes-link gl-flex gl-justify-between gl-rounded-base gl-px-3 gl-py-2 gl-text-primary hover:gl-bg-gray-50 hover:gl-text-gray-900 hover:gl-no-underline"
  >
