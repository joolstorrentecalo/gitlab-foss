...
export default {
  ...
  methods: {
    ...
    handleKeyUp(e) {
      if (e.key === 'Enter') {
        this.$emit('find-and-replace', { find: e.target.value });
      }
    },
  },
  shortcuts: {
...
<template>
  ...
  >
    ...
    <div
      ...
      class="gl-border gl-absolute gl-left-1/2 gl-right-0 gl-z-1 gl-flex gl-rounded-bl-base gl-border-r-0 gl-border-gray-300 gl-bg-inherit gl-p-2 gl-shadow-sm"
    >
      <gl-form-input
