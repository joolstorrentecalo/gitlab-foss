  ...
  module DataSync
    class MoveService < ::WorkItems::DataSync::BaseService
      ...
      def verify_can_move_work_item!(work_item, target_namespace)
        ...
        #   -> check source and target types coincide
        #   -> check source and target namespaces types coincide i.e. ProjectNamespace -> ProjectNamespace
        #      and Group -> Group
        unless work_item.supports_move_and_clone?
          raise MoveError, format(_('MoveWorkItem|Cannot move work items of \'%{issue_type}\' type.'), {
      ...
      def move_work_item
        new_work_item = WorkItems::DataSync::BaseCopyDataService.new(
          work_item: work_item,
        ...
        WorkItems::DataSync::BaseCleanupDataService.new(
