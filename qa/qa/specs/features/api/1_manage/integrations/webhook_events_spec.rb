...
module QA
  RSpec.describe 'Manage' do
    describe(
      ...
      it 'sends a push event', :blocking,
        testcase: 'https://gitlab.com/gitlab-org/gitlab/-/quality/test_cases/348945' do
      ...
      it 'sends a merge request event', :blocking,
        testcase: 'https://gitlab.com/gitlab-org/gitlab/-/quality/test_cases/349720' do
      ...
      it 'sends a wiki page event', :blocking,
        testcase: 'https://gitlab.com/gitlab-org/gitlab/-/quality/test_cases/349722' do
